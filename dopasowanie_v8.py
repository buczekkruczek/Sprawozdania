...
CONFIGS = [
    {
        "usecols": [10, 11],
        "title": "Zlinearyzowana zależność ciśnienia od objętości w sprężaniu adiabatycznym powietrza",
        "filename": "T9_plot1,2.png",
...
X_LABEL = r"Wartość $\ln\left(\frac{V_0}{V(t)}\right)$ [-]"
Y_LABEL = r"Wartość $\ln\left(\frac{P(t)}{P_0}\right)$ [-]"
...
for config in CONFIGS:
    ...
    plt.legend(unique.values(), unique.keys(), fontsize=30, markerscale=3)
